...
class Admin::ImgcategoriesController < ApplicationController
  ...
  def index
    ...
    @categories = Category.all(:gubun => "image", :order => [ :priority.asc ])

     render 'imgcategory', :layout => false
  end
  ...
  def create
    if params[:imgcategories][:name] != "" and params[:imgcategories][:sub_name] == ""
      @category = Category.new
      @category.name = params[:imgcategories][:name]
      @category.gubun = "image"
      @category.priority = params[:imgcategories][:priority].to_i
    ...
    elsif params[:imgcategories][:name] == "" and params[:imgcategories][:sub_name] != ""
